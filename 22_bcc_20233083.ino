...
#define _DUTY_MAX 1750 // 1750
#define _DUTY_NEU 1300 // 1300
#define _DUTY_MIN 850 // 850

#define _SERVO_ANGLE_DIFF  77  // Replace with |D - E| degree
#define _SERVO_SPEED       95  // servo speed

#define _BANGBANG_RANGE    370  // duty up and down for bangbang control
...
float volt_to_distance(int a_value)
{
  ...
  return 679 + -3.03 * a_value + 4.95E-03 * pow(a_value, 2) + -2.95E-06 * pow(a_value, 3);
}
